...
<div class="col-xs-12  hidden-sm  titulo-mobile-producir titulo-mobile"> <p> Producir + > Sanidad </p> </div>
	...
	<a href="#">
		<div class="box-producir-2  box-relleno col-lg-6 col-md-6 col-sm-3 col-xs-6  col-lan-xs-4 hidden-lg hidden-xl hidden-xs hidden-sm hidden-lg hidden-md">
			<div class="box-sanidad border-shadow">
				<div class="box-sanidad-inner producir-box-inner square">
	...
	<a href="">
		<div class="box-producir-2 box-relleno col-lg-6 col-md-6 col-sm-3 col-xs-6 col-lan-xs-4 hidden-xs hidden-sm hidden-md hidden-lg hidden-xl">
	...
	<div class="box-producir-2 box-relleno col-lg-6 col-md-6 col-sm-3 col-xs-6  col-lan-xs-4 hidden-xs hidden-sm hidden-md hidden-lg-2 hidden-lg hidden-xl">
		<div class="box-sanidad">
			<div class="box-sanidad-inner producir-box-inner square">
				<p class="color-sanidad center-to-parent"></p>
			</div>
	...
	<div class="box-producir-2 box-relleno col-lg-6 col-md-6 col-sm-3 col-xs-6  col-lan-xs-4 hidden-xs hidden-lg hidden-xl hidden-sm hidden-md hidden-lg-2">
		<div class="box-sanidad">
			<div class="box-sanidad-inner producir-box-inner square">
				<p class="color-sanidad center-to-parent"></p>
			</div>
