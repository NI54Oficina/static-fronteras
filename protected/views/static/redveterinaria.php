...
<div class="col-xs-12  hidden-sm hidden-md  titulo-mobile-producir titulo-mobile"> <p> Producir + > Red veterinaria </p> </div>

	<div class="map-box  col-lg-12 col-md-6 col-sm-6 col-xs-12 hidden-xs  hidden-lg ">
   ...
   <!-- IFRAME DE MAPA, SETEAR LA LOCACION CORRECTA -->
	...
	<div class="red-box col-lg-12 col-md-6 col-sm-6 col-xs-12">

		    <img class="col-lg-4 col-md-4 col-sm-6 col-xs-12 hidden-xs hidden-lg" src="<?php echo Yii::app()->request->baseUrl; ?>/img/gota-veterinarias.svg" alt="Red Veterinaria">
	...
	<div class="map-box  col-lg-12 col-md-6 col-sm-6 col-xs-12   hidden-sm hidden-md ">
